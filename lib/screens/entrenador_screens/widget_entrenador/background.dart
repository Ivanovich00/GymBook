...
class AnimatedBackground extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final tween = MultiTween<_BgProps>()
      ..add(
          _BgProps.color1, Color.fromRGBO(1, 29, 69, 1).tweenTo(Color.fromRGBO(44, 181, 110, 1)))
      ..add(_BgProps.color2, Color.fromRGBO(44, 181, 110, 1).tweenTo(Color.fromRGBO(1, 29, 69, 1)));
