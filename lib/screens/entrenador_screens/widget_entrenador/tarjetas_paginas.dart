...
import 'package:GymBook/screens/entrenador_screens/calendario_screen.dart';
...
import 'package:GymBook/screens/entrenador_screens/chat_screen.dart';
    ...
    try {
      ...
      if (result.isNotEmpty && result[0].rawAddress.isNotEmpty) {
        await FirebaseFirestore.instance
          ...
          if (user_data.contains('entrenador')) {
                        ...
                        children: [
                          ...
                          Positioned(
                              ...
                              child: Container(
                                ...
                                height: 15,
                                decoration: BoxDecoration(
                                    color: (_visto == false) ? Colors.red : Colors.transparent, 
                                    shape: BoxShape.circle),
                              ),
                            )
                        ],
