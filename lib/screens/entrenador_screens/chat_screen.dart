...
class PantallaHomeChat extends StatefulWidget {
  const PantallaHomeChat({Key? key}) : super(key: key);
  @override
  State<PantallaHomeChat> createState() => _PantallaHomeChatState();
}
...
class _PantallaHomeChatState extends State<PantallaHomeChat> {
                                                  ...
                                                  child: ListView(
                                                    ...
                                                    children:
                                                      snapshot.data!.docs.map((doc) {
                                                        return (doc['nombre'].toString().toLowerCase().contains(_controllerSearch.text.toLowerCase()) || doc['apellido'].toString().toLowerCase().contains(_controllerSearch.text.toLowerCase())) 
                                                        ? GestureDetector(
                                                          onTap: () {
