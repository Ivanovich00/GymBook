...
class PantallaHelpEntrenador extends StatefulWidget {
  final String? nombreControl_entrenador, apellidoControl_entrenador, emailControl_entrenador;
  PantallaHelpEntrenador({Key? key, required this.nombreControl_entrenador, required this.apellidoControl_entrenador, required this.emailControl_entrenador}) : super(key: key);
  @override
  State<PantallaHelpEntrenador> createState() => _PantallaHelpEntrenadorState();
}
...
class _PantallaHelpEntrenadorState extends State<PantallaHelpEntrenador> {
  ...
  Future<void> _initGetDetails() async {
    ...
    _nombreController.text = nombreControl_entrenador![0].toString().toUpperCase() + nombreControl_entrenador.toString().substring(1).toLowerCase();
    _apellidoController.text = apellidoControl_entrenador![0].toString().toUpperCase() + apellidoControl_entrenador.toString().substring(1).toLowerCase();
    _emailController.text = emailControl_entrenador.toString().toLowerCase();
