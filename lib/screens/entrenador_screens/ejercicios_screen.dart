...
import 'package:GymBook/screens/entrenador_screens/widget_entrenador/background.dart';
...
class PantallaEjercicios2 extends StatefulWidget {
  const PantallaEjercicios2({Key? key}) : super(key: key);
  @override
  State<PantallaEjercicios2> createState() => _PantallaEjercicios2State();
}

class _PantallaEjercicios2State extends State<PantallaEjercicios2> {
