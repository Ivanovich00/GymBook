...
final TextEditingController _controllerDescripcion = new TextEditingController();

final TextEditingController _controllerSearch = new TextEditingController();

String dropdownvalue = 'Ordenar de A a Z';
var items =  ['Ordenar de A a Z','Ordenar de Z a A', 'Ordenar de antiguo a reciente', 'Ordenar de reciente a antiguo'];


class PantallaAbdomen extends StatefulWidget {
  const PantallaAbdomen({Key? key}) : super(key: key);
  @override
  State<PantallaAbdomen> createState() => _PantallaAbdomenState();
}

class _PantallaAbdomenState extends State<PantallaAbdomen> {
                    ...
                    children: [
                      ...
                      ? SpeedDialChild(
                        ...
                        onTap: () {
                          ...
                          Navigator.pushReplacement(context, PageTransition(type: PageTransitionType.fade, child: EditarEjercicio(), duration: Duration(milliseconds: 250)));
                        },
        ...
        padding: EdgeInsets.symmetric(horizontal: 8, vertical: 8),
              ...
              splashRadius: 25,
                      ...
                      onPressed: () {
                        ...
                        if(dirty_info_user.toString().contains('administrador')){
                          Navigator.pushReplacement(context, PageTransition(type: PageTransitionType.leftToRight, child: PantallaEjercicios(), duration: Duration(milliseconds: 250)));
                        } else if(dirty_info_user.toString().contains('entrenador')){
                          Navigator.pushReplacement(context, PageTransition(type: PageTransitionType.leftToRight, child: PantallaEjercicios2(), duration: Duration(milliseconds: 250)));
                        } else {
                        ...
                        onChanged: (newValue){
                          dropdownvalue = newValue.toString();
                            if(newValue.toString() == 'Ordenar de A a Z'){
                              _isDescending = false;
                            } else if(newValue.toString() == 'Ordenar de Z a A'){
                              _isDescending = true;
                            } else if(newValue.toString() == 'Ordenar de antiguo a reciente'){
                              _isDescending = false;
                            } else {
                              _isDescending = true;
                            }
                ...
                body: Stack(
                  children: [
                    ...
                    StreamBuilder<QuerySnapshot>(
                      stream: (dropdownvalue.toString() == 'Ordenar de A a Z' || dropdownvalue.toString() == 'Ordenar de Z a A') 
                        ? db.collection('ejercicios').doc('categorias').collection('abdomen').orderBy('nombre', descending: _isDescending).snapshots()
                        : db.collection('ejercicios').doc('categorias').collection('abdomen').orderBy('timestamp', descending: _isDescending).snapshots(),
                      builder: (context, snapshot) {
                      _isConnected();
                                    ...
                                    child: Container(
                                      ...
                                      child: TextField(
                                        ...
                                        decoration: InputDecoration(
                                          ...
                                          prefixIcon: Icon(Icons.search, color: Color.fromRGBO(1, 29, 69, 1),),
                                          suffixIcon: (_controllerSearch.text == '')
                                            ? null
                                            : IconButton(
              splashRadius: 25,
                                              splashColor: Colors.black45,
                                              icon: Icon(Icons.close, color: Color.fromRGBO(1, 29, 69, 1), size: 22.5),
                                              onPressed: () {
                                                _controllerSearch.clear();
                                                setState(() {});
                                              },
                                    ...
                                    child: Padding(
                                      ...
                                      child: Scrollbar(
                                        ...
                                        snapshot.data!.docs.map((doc) {
                                          return (doc['nombre'].toString().toLowerCase().contains(_controllerSearch.text.toLowerCase()) || doc['descripcion'].toString().toLowerCase().contains(_controllerSearch.text.toLowerCase())) ? Padding(
                                                  ...
                                                  onTap: (){
                                                    ...
                                                    if(_nombre == doc['nombre']){
                                                      if(_isPressed){
                                                        ...
                                                        _controllerDescripcion.text = _descripcion!;
                                                        _imagen = doc['imagenURL'];
                                                        uid_final = doc.id;
                                                        _uid = doc.id;
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Icon(Icons.query_stats_rounded,
                                        color: Color.fromRGBO(95, 189, 132, 1), size: 110),
                                    SizedBox(height: 15),
...
class _CrearEjercicioState extends State<CrearEjercicio> {
  ...
  double width = MediaQuery.of(context).size.width;
    ...
    return new SafeArea(
      child: Scaffold(
        backgroundColor: (_isOscuro) ? Color.fromRGBO(31, 31, 31, 1) : Colors.white,
        appBar: AppBar(
          backgroundColor: Color.fromRGBO(72, 83, 98, 1),
          leading: IconButton(
              splashRadius: 25,
              ...
              onPressed: () {
                ...
                Navigator.pushReplacement(context, PageTransition(type: PageTransitionType.fade, child: PantallaAbdomen(), duration: Duration(milliseconds: 250)));
              }),
          elevation: 0,
          title: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
              ...
              children: [
                    ...
                    child: Container(
                      child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                              image: (_filePicked == null || _filePic == null || _namePic == '') ? AssetImage('assets/images/picture_default.png') : (_filePic.toString().contains('File') ? FileImage(_filePic!) as ImageProvider : AssetImage('assets/images/picture_default.png')),
                              fit: BoxFit.cover),
                          ),
                        ),
                    ),
                ...
                Positioned(
                  ...
                  child: new FloatingActionButton(
                    ...
                    child: Icon(Icons.photo_library_sharp, size: 40, color: Colors.white),
                    backgroundColor: Color.fromRGBO(72, 83, 98, 1),
                  )
                )
              ],
                        ...
                        if (result.isNotEmpty && result[0].rawAddress.isNotEmpty) {
                          if (_controllerNombre.text == '' || _controllerDescripcion.text == '') {
                            ...
                            final uid_final = await FirebaseFirestore.instance
                                ...
                                .collection('abdomen')
                                .add({
                              "nombre": toBeginningOfSentenceCase(_controllerNombre.text.trim()),
                              "descripcion": toBeginningOfSentenceCase(_controllerDescripcion.text.trim()),
                              "imagenURL": "https://firebasestorage.googleapis.com/v0/b/gymbook-services.appspot.com/o/picture_default.png?alt=media&token=f6b01dbf-2845-4dc1-9843-9303ca5c7fbc",
                              'timestamp' : Timestamp.now()
                            });

                            if (_namePic.toString().contains('File')) {
                              final destination = 'ejercicios/abdomen/${uid_final.id}/foto_${uid_final.id}';
                  ...
                  child: Container(
                    ...
                    child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                            image: (_filePicked == null || _filePic == null || _namePic == '') ? CachedNetworkImageProvider(_imagen!, maxHeight: 350, maxWidth: 350) : (_filePic.toString().contains('File') ? FileImage(_filePic!) as ImageProvider : AssetImage('assets/images/picture_default.png')),
                            fit: BoxFit.cover),
                        ),
                      ),
                  ),
                      ...
                      try {
                        ...
                        if (result.isNotEmpty && result[0].rawAddress.isNotEmpty) {
                          if (_controllerNombre.text == '' || _controllerDescripcion.text == '') {
                            ...
                            if (_namePic.toString().contains('File')) {
                              final destination = 'ejercicios/abdomen/${_uid}/foto_${_uid}';
                            ...
                            Navigator.push(context, MaterialPageRoute(builder: (context) => const PantallaAbdomen()));
                          }
                        }
                      } catch (_) {
                        Get.snackbar(
