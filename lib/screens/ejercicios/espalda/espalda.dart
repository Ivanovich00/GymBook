...
class PantallaEspalda extends StatefulWidget {
  const PantallaEspalda({Key? key}) : super(key: key);
  @override
  State<PantallaEspalda> createState() => _PantallaEspaldaState();
}

class _PantallaEspaldaState extends State<PantallaEspalda> {
                        ...
                        if (result.isNotEmpty &&
                          ...
                          if (_controllerNombre.text == '' ||
                            ...
                            if (_namePic.toString().contains('File')) {
                              final destination =
                                  'ejercicios/espalda/${uid_final.id}/foto_${uid_final.id}';
                      ...
                      try {
                        ...
                        if (result.isNotEmpty &&
                          ...
                          if (_controllerNombre.text == '' ||
                            ...
                            if (_namePic.toString().contains('File')) {
                              final destination =
                                  'ejercicios/espalda/${_uid}/foto_${_uid}';
