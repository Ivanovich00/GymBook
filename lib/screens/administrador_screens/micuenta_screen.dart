...
final userReference = FirebaseFirestore.instance.collection('administradores');
...
class _PantallaCuentaState extends State<PantallaCuenta> {
                                      ...
                                      child: Container(
                                          ...
                                          child: CircleAvatar(
                                            ...
                                            backgroundImage: (!_isConnected)
                                                ? AssetImage('assets/images/account_default.png')
                                                : (_namePic == 'user')
                                                    ? NetworkImage(profileUrl)
                                                    : (_namePic.toString().contains('File'))
                                                        ? FileImage(_filePic!)
                                                            as ImageProvider
                                                        : (_namePic == 'asset')
                                                            ? AssetImage('assets/images/account_default.png')
  ...
  showCancelarDialog(BuildContext context) {
    ...
    AlertDialog alert = AlertDialog(
      ...
      title: Text("Cancelar actualización", style: TextStyle(
        fontStyle: FontStyle.normal,
        fontSize: 19.0,
        fontWeight: FontWeight.bold,
        color: Colors.black
      )),
      content: Text("¿Estas seguro de no actualizar tu perfil?", style: GoogleFonts.poppins(
                textStyle: TextStyle(
                  fontStyle: FontStyle.normal,
                  fontSize: 17.0,
                  fontWeight: FontWeight.w300,
  ...
  showActualizarDialog(BuildContext context) {
      ...
      onPressed: () async {
        ...
        try {
          ...
          if (result.isNotEmpty && result[0].rawAddress.isNotEmpty) {
            ...
            if (_nombreController.text == '' || _apellidoController.text == '' || _edadController.text == '' || edad_final <= 1 || edad_final >= 99) {
              Get.snackbar(
              ...
              if(_namePic.toString().contains('File')){
                ...
                final destination = 'users/$userdoc/foto_$userdoc';
                  ...
                  try {
                    ...
                    FirebaseFirestore.instance.collection("administradores").doc(userdoc).update({'imagenURL': _isFotoURL}).catchError((error) => _getInternetFailed());
                    FirebaseFirestore.instance.collection("entrenadores").doc(userdoc).update({'imagenURL': _isFotoURL}).catchError((error) => _getInternetFailed());
                  } catch (e) {
                    _getInternetFailed();
                  }
                ...
                if(!profileUrl.contains('account_default')){
                  FirebaseFirestore.instance
                      .collection("administradores")
                      .doc(userdoc)
                      .update({'imagenURL': 'https://firebasestorage.googleapis.com/v0/b/gymbook-services.appspot.com/o/account_default.png?alt=media&token=374b407e-68e7-45d1-ab0e-ec8bd8ae881b'}).catchError(
              ...
              Navigator.pushReplacement(context, MaterialPageRoute(builder: (BuildContext context) => this.widget));
    ...
    AlertDialog alert = AlertDialog(
      ...
      title: Text("Actualizar informacion", style: TextStyle(
        fontStyle: FontStyle.normal,
        fontSize: 19.0,
        fontWeight: FontWeight.bold,
        color: Colors.black
      )),
      content: Text("¿Estas seguro de actualizar tu perfil?", style: GoogleFonts.poppins(
                textStyle: TextStyle(
                  fontStyle: FontStyle.normal,
                  fontSize: 17.0,
                  fontWeight: FontWeight.w300,
