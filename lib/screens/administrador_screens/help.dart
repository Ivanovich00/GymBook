...
class PantallaHelpAdministrador extends StatefulWidget {
  final String? nombreControl, apellidoControl, emailControl;
  PantallaHelpAdministrador({Key? key, required this.nombreControl, required this.apellidoControl, required this.emailControl}) : super(key: key);
  @override
  State<PantallaHelpAdministrador> createState() => _PantallaHelpAdministradorState();
}
...
class _PantallaHelpAdministradorState extends State<PantallaHelpAdministrador> {
  ...
  Future<void> _initGetDetails() async {
    ...
    _nombreController.text = nombreControl![0].toString().toUpperCase() + nombreControl.toString().substring(1).toLowerCase();
    _apellidoController.text = apellidoControl![0].toString().toUpperCase() + apellidoControl.toString().substring(1).toLowerCase();
    _emailController.text = emailControl.toString().toLowerCase();
