...
class IntroduccionAdministrador extends StatefulWidget {
  @override
  State<IntroduccionAdministrador> createState() => _IntroduccionAdministradorState();
}
...
class _IntroduccionAdministradorState extends State<IntroduccionAdministrador> {
  @override
  void initState() {
    _initGetDetails();
    super.initState();
  ...
  try {
    await FirebaseFirestore.instance.collection("administradores").doc(authService.auth.currentUser!.uid).get().then((querySnapshot) {
          ...
          AnimatedContainer(
            ...
            child: IntroductionScreen(
              ...
              pages: [
                PageViewModel(
                  title: _genero,
                  body: "Asigna rutinas de ejercicio a cada uno de los cliente de una manera muy sencilla.",
                  image: Container(
                    child: Image.asset(
                ...
                PageViewModel(
                  ...
                  body: "Agrega ejercicios personalizados a las rutinas de cada cliente por separado.",
                  image: ClipRRect(
                ...
                PageViewModel(
                  ...
                  body: "Guarda cada ejercicio individualmente en las distintas categorías existentes.",
                  image: ClipRRect(
                    borderRadius: BorderRadius.circular(10),
                    child: Image.asset(
                ...
                PageViewModel(
                  title: "Administra usuarios fácilmente",
                  body: "Mantén un orden en el listado de tus usuarios asignando entrenadores de una manera eficaz.",
                  image: ClipRRect(
                    borderRadius: BorderRadius.circular(10),
                    child: Image.asset(
                      "assets/images/introduction/intro_entren_3.jpg",
                      width: 275,
                      height: 275,
                    ),
                  ),
                ...
                PageViewModel(
                  ...
                  body: "Necesitas hablar con algun cliente? Simple, solo selecciónalo y manda un mensaje!",
