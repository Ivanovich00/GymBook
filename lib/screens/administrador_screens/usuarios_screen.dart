...
import 'package:GymBook/screens/administrador_screens/ver_rutinas_screen.dart';
...
String order_entrenadores = "nombre";
bool des_entrenadores = false;
bool sort_entrenadores = false;
List<bool> botsel_entrenadores = [false, true];
enum SortByEntrenadores {nombre, apellido, registro}

String? userdoc_admin, nombre, apellido, edad, email, imagenURL, registro, genero, uid, tipo, _modeUser, uid_f, fecha;

bool rutina = false;
bool _isSelected = false;

final TextEditingController _controllerSearchClientes = new TextEditingController();
final TextEditingController _controllerSearchEntrenadores = new TextEditingController();
...
class _PantallaUsuariosState extends State<PantallaUsuarios>{
  ...
  Future<void> _isConnected() async {
    ...
    sort_entrenadores = false;
    if(order_entrenadores == "nombre"){
      _sortByEntrenadores = SortByEntrenadores.nombre;
    } else if(order_entrenadores == "apellido"){
      _sortByEntrenadores = SortByEntrenadores.apellido;
    } else {
      _sortByEntrenadores = SortByEntrenadores.registro;
    }
  ...
  SortByEntrenadores? _sortByEntrenadores;
                      ...
                      children: [
                        ...
                        (_modeUser == 'entrenador')
                            ? SpeedDialChild(
                                ...
                                backgroundColor: Color.fromRGBO(44, 181, 110, 1),
                                onTap: () async {
                                  setState(() {});
                                  try {
                                    final result = await InternetAddress.lookup('example.com');
                                    if (result.isNotEmpty && result[0].rawAddress.isNotEmpty) {
                                      dialogTransformtoCliente();
                                    }
                                  } catch (_) {
                                    _noInternet();
                                  }
                                ...
                                labelStyle: TextStyle(
                                  ...
                                  color: (_isOscuro)
                                    ...
                                    : Colors.white,
                                  fontSize: 16.0),
                                labelBackgroundColor: Color.fromRGBO(44, 181, 110, 1),
                              )
                            : SpeedDialChild(
                                child: null,
                                backgroundColor: Colors.transparent,
                          ...
                          ? SpeedDialChild(
                              ...
                              onTap: () async {
                                ...
                                try {
                                  final result = await InternetAddress.lookup('example.com');
                                  if (result.isNotEmpty && result[0].rawAddress.isNotEmpty) {
                                    dialogTransformtoEntrenador();
                                  }
                                } catch (_) {
                                  _noInternet();
                                }
                              },
                              label: (genero == 'Hombre' || genero == 'Otro')
                                  ? "Convertir en entrenador"
                                  : "Convertir en entrenadora",
                              labelStyle: TextStyle(
                                  fontWeight: FontWeight.w500,
                                  color: (_isOscuro)
                                      ? Color.fromRGBO(31, 31, 31, 1)
                        ...
                        (_modeUser == 'administrador')
                          ? SpeedDialChild(
                              ...
                              backgroundColor: Color.fromARGB(255, 181, 44, 44),
                              onTap: () async {
                                setState(() {});
                                try {
                                  final result = await InternetAddress.lookup('example.com');
                                ...
                                onTap: () async {
                                  ...
                                  try {
                                    ...
                                    if (result.isNotEmpty &&
                                        ...
                                        dialogTransformtoAdministrador();
                                    }
                                  } catch (_) {
                                    _noInternet();
                                  }
                    ...
                    bottom: PreferredSize(
                      ...
                      child: TabBar(
                        ...
                        onTap: (index) {
                          ...
                          _controllerSearchEntrenadores.clear();
                          sort_clientes = false;
                          sort_entrenadores = false;
                          _isSelected = false;
                          uid = '';
                      ...
                      children: [
                        ...
                        Container(
                          color: (_isOscuro)
                            ...
                            : Colors.white,
                          child: StreamBuilder<QuerySnapshot>(
                            stream: db.collection('entrenadores').orderBy(order_entrenadores, descending: des_entrenadores).snapshots(),
                            builder: (context, snapshot) {
                              if (!snapshot.hasData) {
                                return Container(
                                  color: (_isOscuro)
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                          ...
                                          child: Container(
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                    ...
                                                    children: [
                                                      Container(
                                                        ...
                                                        child: TextField(
                                                          ...
                                                          autocorrect: false,
                                                          textAlignVertical: TextAlignVertical.center,
                                                          controller: _controllerSearchEntrenadores,
                                                          onChanged: (value) {
                                                            setState(() {});
                                                          },
                                                          decoration: InputDecoration(
                                                            contentPadding: EdgeInsets.all(10.0),
                                                            labelText: "Buscar un entrenador...",
                                                            hintText: "Buscar un entrenador...",
                                                            labelStyle: TextStyle(color: (_isOscuro) ? Colors.white : Colors.black),
                                                            hintStyle: TextStyle(color: (_isOscuro) ? Colors.white : Colors.black),
                                                            helperStyle: TextStyle(color: (_isOscuro) ? Colors.white : Colors.black),
                                                            floatingLabelStyle: TextStyle(color: (_isOscuro) ? Colors.white : Colors.black),
                                                      ...
                                                      GestureDetector(
                                                        onTap: (){
                                                          _controllerSearchEntrenadores.text = "";
                                                          setState(() {});
                                                        },
                                                        child: Icon(
                                                          (_controllerSearchEntrenadores.text != '')
                                                ...
                                                Tooltip(
                                                  message: (!sort_entrenadores) ? 'Ordenar por...' : 'Cerrar',
                                                  child: GestureDetector(
                                                    onTap: (){
                                                      sort_entrenadores = !sort_entrenadores;
                                                      setState(() {});
                                                    },
                                                    child: Icon(
                                                      sort_entrenadores
                                        ...
                                        Padding(
                                          ...
                                          child: AnimatedContainer(
                                            width: width - 25,
                                            height: sort_entrenadores ? 225 : 0,
                                            duration: Duration(milliseconds: 500),
                                            curve: Curves.fastOutSlowIn,
                                            decoration: BoxDecoration(
                                              color: (!_isOscuro) ? Colors.white : Color.fromRGBO(31, 31, 31, 255),
                                              ...
                                              child: Column(
                                                children: [
                                                  ListTile(
                                                    ...
                                                    leading: Radio<SortByEntrenadores>(
                                                      fillColor: MaterialStateProperty.resolveWith<Color>((states) {
                                                        if (!states.contains(MaterialState.selected)) {
                                                          return (_isOscuro) ? Colors.white : Colors.black;
                                                        }
                                                      ...
                                                      value: SortByEntrenadores.nombre,
                                                      groupValue: _sortByEntrenadores,
                                                      onChanged: (SortByEntrenadores? value) {
                                                        setState(() {
                                                          _sortByEntrenadores = value;
                                                          order_entrenadores = "nombre";
                                                        });
                                                      },
                                                    ),
                                                    onTap: () {
                                                  ...
                                                  ListTile(
                                                    ...
                                                    leading: Radio<SortByEntrenadores>(
                                                      ...
                                                      value: SortByEntrenadores.apellido,
                                                      groupValue: _sortByEntrenadores,
                                                      onChanged: (SortByEntrenadores? value) {
                                                        setState(() {
                                                          _sortByEntrenadores = value;
                                                          order_entrenadores = "apellido";
                                                        });
                                                      },
                                                    ),
                                                    onTap: () {
                                                  ...
                                                  ListTile(
                                                    ...
                                                    leading: Radio<SortByEntrenadores>(
                                                      ...
                                                      value: SortByEntrenadores.registro,
                                                      groupValue: _sortByEntrenadores,
                                                      onChanged: (SortByEntrenadores? value) {
                                                        setState(() {
                                                          _sortByEntrenadores = value;
                                                          order_entrenadores = "registro";
                                                        });
                                                      },
                                                    ),
                                                    onTap: () {
                                                  ...
                                                  ToggleButtons(
                                                    ...
                                                    borderColor: (_isOscuro) ? Colors.white : Colors.black.withOpacity(0.50),
                                                    constraints: BoxConstraints(minHeight: 36.0),
                                                    isSelected: botsel_entrenadores,
                                                    onPressed: (index) {
                                                      if(botsel_entrenadores[index] == false){
                                                        botsel_entrenadores[0] = !botsel_entrenadores[0];
                                                        botsel_entrenadores[1] = !botsel_entrenadores[1];
                                                      }
                                                      if(botsel_entrenadores[0] == true){
                                                        des_entrenadores = true;
                                                      } else {
                                                        des_entrenadores = false;
                                                      }
                                                      setState(() {});
                                                    },
                                                    children: [
                                            ...
                                            child: Padding(
                                              ...
                                              child: ListView(
                                                children: snapshot.data!.docs.map((doc) {
                                                  ...
                                                  return (doc['nombre'].toString().toLowerCase().contains(_controllerSearchEntrenadores.text.toLowerCase()) || doc['apellido'].toString().toLowerCase().contains(_controllerSearchEntrenadores.text.toLowerCase()))
                                                    ? Card(
                                                      color: Color.fromRGBO(44, 181, 110, 1),
                                                      shape: RoundedRectangleBorder(
                                                        borderRadius: BorderRadius.all(
                        ...
                        Container(
                          color: (_isOscuro)
                            ...
                            : Colors.white,
                          child: StreamBuilder<QuerySnapshot>(
                            stream: db.collection('administradores').orderBy("nombre", descending: false).snapshots(),
                            builder: (context, snapshot) {
                              if (!snapshot.hasData) {
                                return Container(
                                  color: (_isOscuro)
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Icon(Icons.person_off_outlined,
                                          ...
                                          size: 120),
                                      SizedBox(height: 15),
                                      Text('No existen administradores',
                                          style: GoogleFonts.poppins(
                                              fontSize: 20,
                                              color: (_isOscuro)
                                                  ? Colors.white
  ...
  void dialogTransformtoAdministrador() {
    Get.defaultDialog(
        title: (genero == 'Hombre' || genero == 'Otro')
            ? "Convertir en administrador"
            : "Convertir en administradora",
        titlePadding: EdgeInsets.fromLTRB(0, 10, 0, 5),
        backgroundColor: Colors.white,
        titleStyle: TextStyle(color: Colors.black54),
        textConfirm: "Aceptar",
        textCancel: "Cancelar",
        onConfirm: () {
          transformENTRENADORaADMIN();
        },
        onCancel: () => Get.back(),
        cancelTextColor: Color.fromRGBO(1, 29, 69, 1),
        confirmTextColor: Colors.white,
        buttonColor: Color.fromRGBO(1, 29, 69, 1),
        barrierDismissible: false,
        radius: 15,
  ...
  void dialogTransformtoEntrenador() {
    if (uid == 'jqNOu8dCGeOwrKnPYrcKLSuPUmq1') {
      Get.snackbar(
        "Error", // title
        "No se puede modificar la cuenta principal", // message
        icon: Padding(
    ...
    } else if (uid == userdoc_admin) {
      Get.snackbar(
        "Error", // title
        "No se puede modificar la propia cuenta", // message
        icon: Padding(
          padding: const EdgeInsets.only(left: 10),
          child: Icon(Icons.error, color: Colors.white),
        ),
      ...
      Get.defaultDialog(
          ...
          textCancel: "Cancelar",
          onConfirm: () {
            if (_modeUser == 'cliente') {
              transformCLIENTEaENTRENADOR();
            } else {
              transformADMINaENTRENADOR();
            }
          },
          onCancel: () => Get.back(),
          cancelTextColor: Color.fromRGBO(1, 29, 69, 1),
  ...
  void dialogTransformtoCliente() {
    if (uid == userdoc_admin) {
      Get.snackbar(
        "Error", // title
        "No se puede modificar la propia cuenta", // message
        icon: Padding(
  ...
  Future<void> transformENTRENADORaADMIN() async {
    try {
      final result = await InternetAddress.lookup('example.com');
  ...
  Future<void> transformCLIENTEaENTRENADOR() async {
    try {
      final result = await InternetAddress.lookup('example.com');
      ...
      if (result.isNotEmpty && result[0].rawAddress.isNotEmpty) {
        ...
        FirebaseFirestore.instance.collection("users").doc(uid).update({
          ...
          FirebaseFirestore.instance.collection("entrenadores").doc(uid).set({
            'tipo': 'entrenador',
            'nombre': nombre,
            'apellido': apellido,
            'edad': edad,
          ...
          FirebaseFirestore.instance.collection("clientes").doc(uid).delete();
          _isSelected = false;
          uid = '';
        });
      }
  ...
  Future<void> transformENTRENADORaCLIENTE() async {
    try {
      final result = await InternetAddress.lookup('example.com');
      ...
      if (result.isNotEmpty && result[0].rawAddress.isNotEmpty) {
        ...
        FirebaseFirestore.instance.collection("users").doc(uid).update({
          ...
          FirebaseFirestore.instance.collection("clientes").doc(uid).set({
            'rutina': false,
            'nombre': nombre,
            'apellido': apellido,
            'edad': edad,
  ...
  Future<void> transformADMINaENTRENADOR() async {
    try {
      final result = await InternetAddress.lookup('example.com');
