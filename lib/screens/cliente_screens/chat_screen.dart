...
class PantallaChatCliente extends StatefulWidget {
  const PantallaChatCliente({Key? key}) : super(key: key);
  @override
  State<PantallaChatCliente> createState() => _PantallaChatClienteState();
}
...
class _PantallaChatClienteState extends State<PantallaChatCliente> {
                ...
                if (snapshot.data != '') {
                    return Scaffold(
                      ...
                      appBar: AppBar(
                        ...
                        elevation: 0,
                        title: Text(
                          (!_isSelected && uid == '') ? 'CHAT CON ENTRENADORES' : '$nombre $apellido',
                          style: TextStyle(
                            color: Colors.white,
                          )
                        ),
                             ...
                             children: <Widget>[
                              ...
                              Expanded(
                                child: StreamBuilder<QuerySnapshot>(
                                    stream: db.collection('entrenadores').snapshots(),
                                    builder: (context, snapshot) {
                                      _isConnected();
                                          ...
                                          if (!snapshot.data!.docs.isEmpty) {
                                            return Column(
                                              children: [
                                                ...
                                                Expanded(
                                                  child: StreamBuilder<QuerySnapshot>(
                                                    stream: db.collection('chats').doc('tipo').collection('clientes').doc(userdoc).collection('chateo').orderBy('timestamp', descending: true).snapshots(),
                                                                        ...
                                                                        child: GestureDetector(
                                                                          onTap: () {
                                                                            ...
                                                                            if (doc.id != uid) {
                                                                              ...
                                                                              FirebaseFirestore.instance.collection('chats').doc('tipo').collection('clientes').doc(userdoc).collection('chateo').doc(uid).update({
                                                                                "visto": true,
                                                                              });
                                            ...
                                            return Container(
                                              ...
                                              child: Center(
                                                child: Column(
                                                  ...
                                                  crossAxisAlignment: CrossAxisAlignment.center,
                                                  children: [
                                                    Icon(Icons.warning_rounded, color: Colors.red[900], size: 110),
                                                    SizedBox(height: 15),
                      ...
                      : Container(
                        ...
                        height: height,
                        child: StreamBuilder<QuerySnapshot>(
                          stream: db.collection('chats').doc('tipo').collection('clientes').doc(userdoc).collection('chateo').doc(uid).collection('mensajes').orderBy('timestamp', descending: true).snapshots(),
                          builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
                                          ...
                                          children: snapshot.data!.docs.map((doc) => new ListTile(
                                            ...
                                            onTap: (){
                                              ...
                                              child: Container(
                                                ...
                                                child: Padding(
                                                  padding: (doc['uid_remitente'] == userdoc)
                                                    ? EdgeInsets.only(top: 8, left: 70, bottom: (_textSelected == doc['texto']) ? 8 : 0, right: 5)
                                                    : EdgeInsets.only(top: 8, left: 5, bottom: (_textSelected == doc['texto']) ? 8 : 0, right: 70),
                                                    child: Container(
                                                      padding: EdgeInsets.only(top: 8, left: 10, bottom: 8, right: 10),
                                                      decoration: BoxDecoration(
                                                        color: (doc['uid_remitente'] == userdoc)
                                                          ? Color.fromRGBO(44, 181, 110, 1)
                                                          : Color.fromRGBO(110, 110, 110, 1),
                                                        borderRadius: (doc['uid_remitente'] == userdoc)
                                                          ? BorderRadius.only(topRight: Radius.circular(10.0), bottomRight: Radius.circular(0.0), topLeft: Radius.circular(10.0), bottomLeft: Radius.circular(10.0))
                                                          : BorderRadius.only(topRight: Radius.circular(10.0), bottomRight: Radius.circular(10.0), topLeft: Radius.circular(0), bottomLeft: Radius.circular(10.0)),
                                                      ),
                                                      child: Text(doc["texto"], textAlign: TextAlign.justify, style: GoogleFonts.ubuntu(
                                                              fontSize: 14,
                                                              color: Colors.white,
                                                              fontWeight: FontWeight.normal
                                                            )),
                                                                                              ...
                                                                                              onTap: () async {
                                                                                                FocusScope.of(context).unfocus();
                                                                                                   if (_controllerMessage.text != '') {
                                                                                                      FirebaseFirestore.instance.collection('chats').doc('tipo').collection('clientes').doc(userdoc).collection('chateo').doc(uid).set({
                                                                                                      ...
                                                                                                      FirebaseFirestore.instance.collection('chats').doc('tipo').collection('entrenadores').doc(uid).collection('chateo').doc(userdoc).set({
                                                                                                       "texto": _controllerMessage.text.trim(),
                                                                                                       "nombre": nombre_user,
                                                                                                      ...
                                                                                                      FirebaseFirestore.instance.collection('chats').doc('tipo').collection('clientes').doc(userdoc).collection('chateo').doc(uid).collection('mensajes').add({
                                                                                                       "texto": _controllerMessage.text.trim(),
                                                                                                       "timestamp": Timestamp.now(),
                                                                                                       "uid_remitente": userdoc,
                                                                                                      });

                                                                                                      FirebaseFirestore.instance.collection('chats').doc('tipo').collection('entrenadores').doc(uid).collection('chateo').doc(userdoc).collection('mensajes').add({
                                                                                                       "texto": _controllerMessage.text.trim(),
                                                                                                       "timestamp": Timestamp.now(),
                                                                                                       "uid_remitente": userdoc,
                                                                                                      });

                                                                                                      FirebaseFirestore.instance.collection('chats').doc('tipo').collection('entrenadores').doc(uid).set({
                                                                                                       "visto": false,
                                                                                                      });
                                                                                                    _controllerMessage.clear();
                                                                                                  }
